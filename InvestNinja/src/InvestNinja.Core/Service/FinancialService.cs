...
namespace InvestNinja.Core.Service
{
    public class FinancialService : IFinancialService
    {
        ...
        public double CalcularTaxaEmValorFuturo(double fv, double pv, int n)
        {
            throw new NotImplementedException();
        }

        public double CalcularTaxaJuros(double pv, int n, double j)
        {
            throw new NotImplementedException();
        }

        public double CalcularTempo(double pv, double i, double j)
        {
            throw new NotImplementedException();
        }

        public double CalcularTempoEmValorFuturo(double fv, double pv, double i)
        {
            throw new NotImplementedException();
        }

        public double CalcularTotalJurosSimples(double pv, double i, int n)
        {
            throw new NotImplementedException();
        }

        public double CalcularValorFuturo(double pv, double i, int n)
        {
            throw new NotImplementedException();
        }

        public double CalcularValorPresente(double i, int n, double j)
        {
            throw new NotImplementedException();
        }

        public double CalcularValorPresenteEmMontante(double fv, double i, int n)
        {
            throw new NotImplementedException();
        }
    }
